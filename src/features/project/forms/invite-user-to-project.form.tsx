...
type _ProjectSharedCreateDTO = z.infer<typeof addUserToProjectSchema>;
...
export default function InviteUserToProjectForm({
  ...
  const form = useForm<_ProjectSharedCreateDTO>({
  ...
  async function onSubmit(values: _ProjectSharedCreateDTO) {
    try {
